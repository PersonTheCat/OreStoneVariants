...
{
	private static boolean quarkJasperOn, quarkLimestoneOn, quarkMarbleOn, quarkSlateOn;
	...
	public static void readQuarkConfig()
	{
		if (Loader.isModLoaded("quark"))
		{
			...
			quarkSlateOn = quarkConfig.get("world.revamp stone gen", "Enable Slate", true).getBoolean();
		}
	}

	public static boolean quarkStonesEnabled() {
	    return quarkJasperOn && quarkLimestoneOn && quarkMarbleOn && quarkSlateOn;
    }
