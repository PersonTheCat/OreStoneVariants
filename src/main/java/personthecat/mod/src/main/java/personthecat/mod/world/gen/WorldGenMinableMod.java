...
public class WorldGenMinableMod extends WorldGenerator
{
    ...
    private final IBlockState matcher;
    
    public WorldGenMinableMod(IBlockState state, int count, IBlockState matcher)
    {
    	this.state = state;
    	this.count = count;
	...
	@Override //Shameless copypasta. This hurts me. 
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                        {
                            for (int j2 = l; j2 <= k1; ++j2)
                            {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D)
                                {
                                    ...
                                    //Begin changes to WorldGenMinable
                                    IBlockState foundState = worldIn.getBlockState(blockpos);
                                    if (foundState.equals(matcher))
                                    {
