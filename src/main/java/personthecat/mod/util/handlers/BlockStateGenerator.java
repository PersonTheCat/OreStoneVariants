...
public class BlockStateGenerator
{
	...
	{		
		//    					dependency,		dep.name,			trans key,					bg registry,				(optional) force texture location	
		...
		private String dependency, languageKey, backgroundBlock, forceTextureLocation;
		...
		private State(List<State> dependency, String dependencyName, String languageKey, String backgroundBlock)
		{
			...
			languageKey = insertModName(insertBlockName(languageKey));
			backgroundBlock = insertModName(insertBlockName(backgroundBlock));
		...
		private State(List<State> dependency, String dependencyName, String languageKey, String backgroundBlock, String forceTextureLocation)
		{
			this(dependency, dependencyName, languageKey, backgroundBlock);
